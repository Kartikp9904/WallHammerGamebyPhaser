...
export default class Splash extends Phaser.Scene {
  ...
  /*
    ...
    */
    showTitle() {
      ...
      const wallStartX = this.center_width - (letterSpacing * (word1.length - 1)) / 2;
      const hammerStartX = this.center_width - (letterSpacing * (word2.length - 1)) / 2;
      ...
      word1.split("").forEach((letter, i) => {
        this.time.delayedCall(
          ...
          () => {
            ...
            let x = wallStartX + i * letterSpacing;
            let text = this.add
              .bitmapText(x, 200, "hammerfont", letter, 170)
              .setTint(0xca6702)
              .setOrigin(0.5)
      ...
      word2.split("").forEach((letter, i) => {
        this.time.delayedCall(
          ...
          () => {
            ...
            let x = hammerStartX + i * letterSpacing;
            let text = this.add
              .bitmapText(x, 350, "hammerfont", letter, 170)
              .setTint(0xca6702)
              .setOrigin(0.5)
              .setDropShadow(4, 6, 0xf09937, 0.9);
  ...
  showInstructions() {
    ...
    this.add
      ...
      .setOrigin(0.5);
    this.add
      .sprite(this.center_width - 200, 620, "pello")
      .setOrigin(0.5)
      .setScale(0.10);
    this.add
      .bitmapText(this.center_width + 40, 620, "pixelFont", "By PELLO (Edited By Kartik)", 15)
      .setOrigin(0.5);
    this.space = this.add
      .bitmapText(
        this.center_width,
